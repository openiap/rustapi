...
cross build --target x86_64-pc-windows-gnu -v --release && cp target/x86_64-pc-windows-gnu/release/openiap.dll target/lib/openiap-windows-x64.dll
# cross build --target i686-pc-windows-gnu -v --release && cp target/i686-pc-windows-gnu/release/openiap.dll target/lib/openiap-windows-x86.dll
