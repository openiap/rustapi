...
public class cli {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // CreateCollection createColParams = new
            // CreateCollection.Builder("testjavacollection")
            // .build();
            ...
            // CreateCollection createExpColParams = new
            // CreateCollection.Builder("testjavaexpcollection")
            // .expire(60)
            // .build();
            ...
            // "ts");
            // CreateCollection createTSColParams = new
            // CreateCollection.Builder("testjavatscollection")
            ...
            // "ts", "metadata");
            // CreateCollection createTSColParams2 = new
            // CreateCollection.Builder("testjavats2collection")
            ...
            // System.out.println("UpdateOne Result (Entity): " + updatedEntity.name + " id:
            // " + updatedEntity._id);

            // InsertOrUpdateOneParameters insertOrUpdateOneParams = new
            // InsertOrUpdateOneParameters.Builder()
            // .collectionname("entities")
            // .uniqeness("name")
            ...
            // String insertOrUpdateOneResult =
            // client.insertOrUpdateOne(insertOrUpdateOneParams);
            // System.out.println("InsertOrUpdateOne Result (JSON): " +
            // insertOrUpdateOneResult);

            // InsertOrUpdateOneParameters insertOrUpdateOneParams2 = new
            // InsertOrUpdateOneParameters.Builder()
            // .collectionname("entities")
            // .uniqeness("name")
            // .item("{\"_type\":\"test\", \"name\":\"test01-uniqene\", \"now\":\"" +
            ...
            // entities.add(new Entity(){{name = "insertmany1"; _type = "test"; java =
            // "many"; }});
            // entities.add(new Entity(){{name = "insertmany2"; _type = "test"; java =
            // "many"; }});
            ...
            // String jsonItems = "[{\"_type\":\"test\", \"java\":\"many\",
            // \"name\":\"insertmany3\"}, {\"_type\":\"test\", \"java\":\"many\",
            // \"name\":\"insertmany4\"}]";
            ...
            // List<Entity> insertedEntities = client.insertMany(new
            // TypeReference<List<Entity>>() {}.getType(), insertManyParams2);
            ...
            // .collectionname("entities")
            // .itemFromObject(new Entity(){{name = "watchtest"; _type = "test"; java =
            // "many"; }})
            // .build()
            // );
            // do {
